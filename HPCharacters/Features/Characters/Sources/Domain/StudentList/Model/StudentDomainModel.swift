...
public struct StudentDomainModel: BaseDomainModel, Codable, Identifiable, Equatable {
    public static func == (lhs: StudentDomainModel, rhs: StudentDomainModel) -> Bool {
        lhs.id  == rhs.id
    }
...
// MARK: - Wand
public struct WandDomain: Codable {
