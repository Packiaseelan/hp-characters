...
final class StudentDetailsRepositoryTests: XCTestCase {
    private var repository: StudentDetailsRepository!
    private var mockService: MockStudentDetailsService!
    private var cancellables: Set<AnyCancellable> = []

    override func setUp() {
        super.setUp()
        mockService = MockStudentDetailsService()
        repository = StudentDetailsRepository(service: mockService)
    }
    ...
    func testFetchStudentDetails_Success() {
        ...
        // Act
        repository.fetchStudentDetails(id: "9e3f7ce4-b9a7-4244-b709-dae5c1f1d4a8")
            .sink { result in
    ...
    func testFetchStudentDetails_Failure() {
        ...
        // Act
        repository.fetchStudentDetails(id: "1")
            .sink { result in
